			          	...
			          	<?php if (isset($_SESSION['shopping_cart']['data'])):
			          		...
			          		foreach ($_SESSION['shopping_cart']['data'] as $product_id => $data): 
			          			...
			          			<tr>
						              	...
						              	<div style="margin-left:60px;">
						              		...
						              		<div class="product_cart">
						              			...
						              			foreach ($infos['data'] as $info)
								            		foreach ($info as $row)
								            			$total += (int)$row['price'];
								            	$price_pro = $data['base_price'];	 
								            	if ($total != 0)
								            		$price_pro = $total + $data['base_price'];
								            	?>
						              			<span id="sell_price_pro_<?php echo $data['product_id']?>" data-price="<?php echo $data['base_price'] ?>"><?php echo number_format($price_pro) ?></span> VND 
					              			</div>
						              	</div>
						            </td>
						            <td>
						            ...
						            <td class="product_cart">
						            	<b><span class="price-pro" id="price_pro_<?php echo $count?>" data-price="<?php echo $arr_price[$key_infos] ?>"><?php echo number_format($arr_price[$key_infos]) ?></span> VND</b>
						            </td>
