            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="row m-b-30">
                        <a href="<?php echo base_url('admin/paymentC/create')?>" class="btn btn-create"><i class="fa fa-plus"></i> Thêm mới</a>
                        <btn data-href="<?php echo base_url('admin/paymentC/bulkDelete')?>" class="btn btn-danger bulk-delete"><i class="fa fa-trash-o"></i> Xóa tất cả</btn>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                                        ...
                                        <?php foreach ($models as $model): ?>
                                            <tr id="tr-<?php echo $model->id?>">
                                                ...
                                                <td class="button-column">
                                                    <a class="btn btn-danger" href="<?php echo base_url('admin/paymentC/update/'.$model->id)?>"><i class="fa fa-edit"></i></a>
     ...
     $(document).ready(function() {
         ...
         $('.button-delete').click(function() {
             if (confirm('Are you sure want to delete this item?')) {
                 var id = $(this).data('id');
                 $.ajax({
                     url: '<?php echo base_url('admin/paymentC/delete')?>'+'/'+id,
                     type: 'POST',
