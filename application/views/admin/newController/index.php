 <div class="row bg-title">
     ...
     <?php
        $breadcrumb = [base_url('admin/system') => 'Dashboard', 'active' => 'Tin Tức'];
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="row m-b-30">
                        <a href="<?php echo base_url('admin/newController/create')?>" class="btn btn-create"><i class="fa fa-plus"></i> Thêm mới</a>
                        <btn data-href="<?php echo base_url('admin/newController/bulkDelete')?>" class="btn btn-danger bulk-delete"><i class="fa fa-trash-o"></i> Xóa tất cả</btn>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
     ...
     $(document).ready(function() {
         ...
         $('.button-delete').click(function() {
             if (confirm('Are you sure want to delete this item?')) {
                 var id = $(this).data('id');
                 $.ajax({
                     url: '<?php echo base_url('admin/newController/delete')?>'+'/'+id,
                     type: 'POST',
          ...
          $('.button-view').click(function() {
              var id = $(this).data('id');
              $.ajax({
                  url: '<?php echo base_url('admin/newController/view')?>'+'/'+id,
                  type: 'POST',
         ...
         $('.publish-ajax').on('change', function() {
             ...
             $.ajax({
                 url: '<?php echo base_url('admin/newController/ajaxPublish')?>',
                 type: 'POST',
