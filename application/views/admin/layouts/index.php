...
<body>
    ...
    <div id="wrapper">
        <?php
            if ($this->router->fetch_class() != 'login') {
                ...
                <div id="page-wrapper">
                    ...
                    <footer class="footer text-center"> 2018 © CÔNG TY TNHH CÔNG NGHỆ OPTECH </footer>
                </div>
        <?php } else {
        ...
        <script src="<?php echo base_url('themes/admin/js/dataTables.buttons.min.js'); ?>"></script>
        <script src="<?php echo base_url('themes/admin/js/buttons.flash.min.js'); ?>"></script>
        <script src="<?php echo base_url('themes/admin/js/jszip.min.js'); ?>"></script>
        <script src="<?php echo base_url('themes/admin/js/pdfmake.min.js'); ?>"></script>
        <script src="<?php echo base_url('themes/admin/js/vfs_fonts.js'); ?>"></script>
        <script src="<?php echo base_url('themes/admin/js/buttons.html5.min.js'); ?>"></script>
        <script src="<?php echo base_url('themes/admin/js/buttons.print.min.js'); ?>"></script>
