<div class="row bg-title">
    ...
    <?php
        $breadcrumb = [base_url('admin/system') => 'Dashboard', base_url('admin/categoryNews') => 'Danh mục', 'active' => $title];
        ...
        <div class="white-box">
            ...
            <?php echo form_open_multipart($link_submit, ['class' => 'form-horizontal']); ?>
                ...
                <div class="col-xs-12 text-center">
                    ...
                    <a href="<?php echo base_url('admin/categoryNews')?>" class="btn btn-inverse waves-effect waves-light">Hủy</a>
                </div>
            <?php echo form_close(); ?>
            </div>
        </div>
