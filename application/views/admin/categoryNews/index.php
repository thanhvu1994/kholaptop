    ...
    <div class="col-sm-12">
        <div class="white-box">
            <div class="row m-b-30">
                <a href="<?php echo base_url('admin/categoryNews/create')?>" class="btn btn-create"><i class="fa fa-plus"></i> Thêm mới</a>
                <button data-href="<?php echo base_url('admin/categoryNews/bulkDelete')?>" class="btn btn-danger bulk-delete"><i class="fa fa-trash-o"></i> Xóa tất cả</button>
            </div>
            <div class="row">
                <div class="col-sm-12">
    ...
    $(document).ready(function() {
        ...
        $('.button-delete').click(function() {
            if (confirm('Are you sure want to delete this item?')) {
                var id = $(this).data('id');
                $.ajax({
                    url: '<?php echo base_url('admin/categoryNews/delete')?>'+'/'+id,
                    type: 'POST',
                    dataType: "json",
